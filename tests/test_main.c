...
int main(void) {
    ...
    RUN_TEST(test_parser_alloca_explicit_align);
    ...
    RUN_TEST(test_parser_disambiguates_llvm_abi_local_function_collision);
    ...
    RUN_TEST(test_jit_internal_global_address_via_helper_call);
    RUN_TEST(test_jit_internal_global_struct_helper_dispatch);
    ...
    RUN_TEST(test_jit_varargs_external_gp_stack_mix);
    ...
    RUN_TEST(test_jit_large_global_array);
    ...
    RUN_TEST(test_session_direct_forward_global_lookup_contract_copy_patch);
    ...
    RUN_TEST(test_session_bc_preserves_x86_fp80);
    ...
    RUN_TEST(test_session_blob_export_ir_mode_contract);
    ...
    RUN_TEST(test_llvm_c_shim_cross_module_internal_global_ptr_call);
    RUN_TEST(test_llvm_c_shim_cross_module_internal_global_struct_dispatch);
