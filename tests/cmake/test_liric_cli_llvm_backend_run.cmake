...
# Drive the CLI object/executable emission through the real LLVM backend
# (LIRIC_COMPILE_MODE=llvm) to prove .ll input round-trips: parse -> LLVM IR
# text -> LLVM AOT object -> link -> execute.
...
execute_process(
    COMMAND ${CMAKE_COMMAND} -E env LIRIC_COMPILE_MODE=llvm "${CLI}" "${INPUT}"
...
if(NOT rc EQUAL 0)
    message(FATAL_ERROR "llvm-backend emit failed rc=${rc}\nstdout:\n${out}\nstderr:\n${err}")
endif()
if(NOT EXISTS "${EXE}")
