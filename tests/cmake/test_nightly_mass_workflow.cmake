...
if(NOT workflow_text MATCHES "os:[ \t]*\\[[^]]*ubuntu-latest[^]]*\\]")
    message(FATAL_ERROR "workflow matrix must include ubuntu-latest")
endif()
if(NOT workflow_text MATCHES "os:[ \t]*\\[[^]]*ubuntu-24\\.04-arm[^]]*\\]")
    message(FATAL_ERROR "workflow matrix must include ubuntu-24.04-arm")
endif()
if(NOT workflow_text MATCHES "os:[ \t]*\\[[^]]*macos-14[^]]*\\]")
    message(FATAL_ERROR "workflow matrix must include macos-14")
endif()
...
if(NOT workflow_text MATCHES "lfortran_emit_fail_count")
    message(FATAL_ERROR "workflow trend summary must report lfortran_emit_fail_count")
endif()
if(NOT workflow_text MATCHES "liric_compat_failure_count")
    message(FATAL_ERROR "workflow trend summary must report liric_compat_failure_count")
endif()
