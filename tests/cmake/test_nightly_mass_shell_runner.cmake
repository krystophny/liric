...
file(WRITE "${COMPAT_FAIL}"
    ...
    "{\"name\":\"case_liric_only_stdout\",\"source\":\"/tmp/h.f90\",\"options\":\"\",\"llvm_ok\":true,\"liric_ok\":true,\"lli_ok\":true,\"liric_match\":false,\"lli_match\":true,\"llvm_rc\":0,\"liric_rc\":0,\"lli_rc\":0,\"error\":\"\"}\n"
...
if(NOT summary_fail MATCHES "\"mismatch_count\"[ \t]*:[ \t]*3")
    message(FATAL_ERROR "expected mismatch_count=3 in fail summary")
endif()
...
if(NOT summary_fail MATCHES "\"liric_compat_failure_count\"[ \t]*:[ \t]*5")
    message(FATAL_ERROR "expected liric_compat_failure_count=5 in fail summary")
endif()
...
if(NOT summary_fail MATCHES "output-format\\|wrong-stdout\\|general")
    message(FATAL_ERROR "expected liric-only wrong-stdout taxonomy bucket in fail summary")
endif()
if(NOT summary_fail MATCHES "output-format\\|wrong-stdout\\|noncomparable-ir")
    message(FATAL_ERROR "expected noncomparable wrong-stdout taxonomy bucket in fail summary")
endif()
...
if(NOT summary_fail_md MATCHES "output-format\\|wrong-stdout\\|general")
    message(FATAL_ERROR "expected liric-only wrong-stdout entry in fail summary markdown")
endif()
if(NOT summary_fail_md MATCHES "output-format\\|wrong-stdout\\|noncomparable-ir")
    message(FATAL_ERROR "expected noncomparable wrong-stdout entry in fail summary markdown")
endif()
