...
public:
    ...
    Expected<JITEvaluatedSymbol> lookup(StringRef Name) {
        ...
        return JITEvaluatedSymbol((uint64_t)(uintptr_t)addr, liric_llvm::JITSymbolFlags());
    }
#else
    Expected<ExecutorSymbolDef> lookup(StringRef Name) {
        ...
        return ExecutorSymbolDef(ExecutorAddr::fromPtr(addr), liric_llvm::orc::JITSymbolFlags());
    }
#endif
};
